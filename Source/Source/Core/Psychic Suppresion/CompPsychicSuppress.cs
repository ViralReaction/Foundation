...

{
    public class CompPsychicSuppressionField : ThingComp
    {
        ...
        private const string CurrentEffectKey = "SCP.SuppressionField.CurrentEffect";
        private const string CurrentRadiusKey = "SCP.SuppressionField.CurrentRadius";
        private const string ConfigureSuppressionFieldKey = "SCP.SuppressionField.ConfigureSuppressionField";
        private const string ConfigureSuppressionFieldDescKey = "SCP.SuppressionField.ConfigureSuppressionFieldDesc";
